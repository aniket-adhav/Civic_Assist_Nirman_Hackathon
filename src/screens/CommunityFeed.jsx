...
export default function CommunityFeed() {
  ...
  return (
    <div className="animate-fadeIn">
      ...
      {/* Category filters */}
      <div className="mb-5">
        <div className="flex gap-2 w-full overflow-x-auto md:overflow-visible scrollbar-hide">
          {[
              { id: 'all', label: 'All', icon: 'fa-fire' },
              { id: 'myarea', label: 'My Area', icon: 'fa-location-dot', special: true },

              // 👉 All categories except sewage & other
              ...CATEGORIES
                .filter(c => c.id !== 'sewage' && c.id !== 'other')
                .map(c => ({ ...c, label: categoryLabel(c.id) })),

              // ✅ Add Sewage before Other
              { id: 'sewage', label: 'Sewage', icon: 'fa-water' },
            ...
            return (
              <button
                ...
                className={`flex items-center justify-center gap-1 px-2 py-1.5 rounded-full text-[11px] font-medium border whitespace-nowrap transition-all duration-200 md:flex-1 ${
                  isActive
